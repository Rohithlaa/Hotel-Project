                                ...
                                <div className="card flex-fill w-100 border">
                                    ...
                                    <div className="card-body">
                                        <div className="row g-3">
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <label className="form-label text-muted " for="validationCountry">Country Code</label>
                                                    <div className="input-group">
                                                        <span className="input-group-text"><i className="bi bi-geo-alt"></i></span>
                                                        <input type="text" className={`form-control ${ 0===1 && "is-invalid"}`} placeholder="Country Code" aria-describedby="validationCountryFeedback" required/>
                                                        { 0===1 &&
